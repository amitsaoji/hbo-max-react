...
export default function SingleMediaPage(props) {
  ...
  //   axios
  //     .get(
  //       `https://api.themoviedb.org/3/movie/${props.query.id}?api_key=35f10c27bb90f7965aa413322662125f&language=en-US`
  //     )
...
export async function getServerSideProps(context) {
  ...
  try {
    mediaData = await axios.get(
      `https://api.themoviedb.org/3/${context.query.mediaType}/${context.query.id}?api_key=35f10c27bb90f7965aa413322662125f&language=en-US`
    );
  } catch (error) {
    console.log(error);
  }
